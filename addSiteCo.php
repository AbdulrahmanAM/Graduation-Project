...
<head>
    <title>Add Site Coordinator</title>
...
<div class="wrapper row2">
    ...
    <div style="position: relative; bottom: 66%; left: 22%; border: solid; width: 50%;">
        ...
        <p> <label><b>Add Site Coordinator:</b></label> 
        </p>
        <form action="AddSiteCos.php" method="post">
            
           <label>Site Coordinator ID:</label><input type="text" autocomplete="off" name="SiteCoo_Email"><br><br>  
            <label>Username:</label><input autocomplete="off" type="text" name="Username"><br><br> 
            <label>Password:</label><input type="password" autocomplete="off" name="Password"><br><br> 
...
echo "<select name=CompanyName value=''>Select the Site</option>"; // list box select command
...
/* Option values are added by looping through the array */ 
 ...
 echo "</select>";// Closing of list box ?> <br><br> 
            
            <label>First name:</label><input type="text" autocomplete="off" name="Fname"><br><br> 
            <label>Last name:</label><input type="text" autocomplete="off" name="Lname"><br><br> 
            
            <label>Phone number:</label><input type="text" autocomplete="off" name="Phone"><br><br> 
